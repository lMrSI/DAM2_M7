...
public final class SeriesBinding implements ViewBinding {
  @NonNull
  ...
  private SeriesBinding(@NonNull ConstraintLayout rootView, @NonNull Button button6,
  ...
  @NonNull
  public static SeriesBinding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static SeriesBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.series, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SeriesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SeriesBinding((ConstraintLayout) rootView, button6, imageView20, imageView21,
