...
public final class PeliculasBinding implements ViewBinding {
  @NonNull
  ...
  private PeliculasBinding(@NonNull ConstraintLayout rootView, @NonNull Button button6,
  ...
  @NonNull
  public static PeliculasBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PeliculasBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.peliculas, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PeliculasBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PeliculasBinding((ConstraintLayout) rootView, button6, imageView20, imageView21,
