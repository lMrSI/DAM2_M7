...
public final class AnimeBinding implements ViewBinding {
  @NonNull
  ...
  private AnimeBinding(@NonNull ConstraintLayout rootView, @NonNull Button button6,
      @NonNull ImageView imageView20, @NonNull ImageView imageView22,
      ...
      @NonNull ImageView imageView40, @NonNull Button menu4, @NonNull TextView textView26,
  ...
  @NonNull
  public static AnimeBinding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static AnimeBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.anime, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AnimeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AnimeBinding((ConstraintLayout) rootView, button6, imageView20, imageView22,
          imageView23, imageView26, imageView28, imageView29, imageView30, imageView31, imageView32,
          imageView33, imageView34, imageView35, imageView36, imageView37, imageView38, imageView39,
          imageView40, menu4, textView26, textView35, textView36, textView37, textView38,
          textView39, textView40);
    }
